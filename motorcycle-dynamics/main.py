...
from ui_handling import draw_ui, handle_button_click, handle_checkbox_click, handle_keydown_event, mass_input_active, input_text, draw_confirmation_prompt, handle_confirmation_click
import config
...
prompt_rect, yes_button, cancel_button = None, None, None
...
def main(screen):
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if confirmation_active:
                    print("Handling confirmation click")
                    handle_confirmation_click(mouse_pos, prompt_rect, yes_button, cancel_button, clear_all)
                else:
        ...
        if confirmation_active:
            ...
            prompt_rect, yes_button, cancel_button = draw_confirmation_prompt(screen, "Confirmation", "Confirm clear all entities?", clear_all)
